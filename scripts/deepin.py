...
if distro.release in ["15.5", "15.6"]:
    class PostInstall:
        ...
        if helper.perm("/usr/share/sounds/deepin/stereo/desktop-login.ogg") == "0":
        ...
        def activate_startup_sound(self, g=False):
            helper.perm("/usr/share/sounds/deepin/stereo/desktop-login.ogg", "755", True)
            helper.perm("/usr/share/sounds/deepin/stereo/desktop-logout.ogg", "755", True)
            helper.perm("/usr/share/sounds/deepin/stereo/system-shutdown.ogg", "755", True)

        def disable_startup_sound(self, g=False):
            helper.perm("/usr/share/sounds/deepin/stereo/desktop-login.ogg", "000", True)
            helper.perm("/usr/share/sounds/deepin/stereo/desktop-logout.ogg", "000", True)
            helper.perm("/usr/share/sounds/deepin/stereo/system-shutdown.ogg", "000", True)
